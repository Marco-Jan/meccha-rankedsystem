...
namespace MecchaRanked
{
    ...
    static class Sprache
    {
        ...
        static readonly Dictionary<string, string[]> W = new Dictionary<string, string[]>
        {
            ...
            { "Zur Freigabe eingereicht – gewertet wird erst nach Prüfung",
              new[] { "Submitted for review – it counts once it has been checked.",
                      "已提交待审核 – 通过审核后才计入。",
                      "確認待ちとして送信しました – 承認されてから加算されます。" } },
            { "Dieses Bild wurde schon eingereicht",
              new[] { "This image has already been submitted.",
                      "这张图片已经提交过了。",
                      "この画像はすでに送信済みです。" } },
            { "Diese Partie hat {0} schon eingeschickt – sie zählt nur einmal",
              new[] { "{0} already submitted this match – it only counts once.",
                      "{0} 已经提交过这一局 – 只会计入一次。",
                      "この試合はすでに {0} が送信しています – 一度しか加算されません。" } },
            { "Diese Partie wurde schon eingeschickt – sie zählt nur einmal",
              new[] { "This match has already been submitted – it only counts once.",
                      "这一局已经提交过 – 只会计入一次。",
                      "この試合はすでに送信済みです – 一度しか加算されません。" } },
            { "Dein Name {0} steht so nicht in dieser Rangliste. Gelesen wurde:",
              new[] { "Your name {0} does not appear like that on this scoreboard. What was read:",
                      "排行榜上没有这样的名字 {0}。识别到的是：",
                      "このスコアボードに {0} という名前は見つかりません。読み取れたのは：" } },
            { "Dein Name steht mehrfach in der Rangliste – bitte im Discord bei einem Admin melden",
              new[] { "Your name appears more than once on the scoreboard – please contact an admin on Discord.",
                      "排行榜上出现了多个同名条目 – 请在 Discord 联系管理员。",
                      "スコアボードにあなたの名前が複数あります – Discord で管理者にご連絡ください。" } },
            { "Für deinen Zugang ist kein Ingame-Name hinterlegt – bitte im Discord bei einem Admin melden",
              new[] { "No in-game name is stored for your access – please contact an admin on Discord.",
                      "你的访问权限没有登记游戏内名称 – 请在 Discord 联系管理员。",
                      "あなたのアクセスにゲーム内名が登録されていません – Discord で管理者にご連絡ください。" } },
            { "Zu deinem Ingame-Namen gibt es kein angemeldetes Konto. Melde dich auf der Seite mit Steam an und trag den Namen dort ein – erst dann kann eine Runde dir zugeordnet werden.",
              new[] { "There is no registered account for your in-game name. Sign in with Steam on the website and enter the name there – only then can a round be credited to you.",
                      "你的游戏内名称没有对应的注册账号。请在网站上用 Steam 登录并填写该名称 – 之后回合才能记到你名下。",
                      "あなたのゲーム内名に対応する登録アカウントがありません。サイトで Steam にログインして名前を登録してください – それではじめてラウンドが記録されます。" } },
            { "Wo das Programm liegt",
              new[] { "Where the app lives", "程序所在位置", "アプリの場所" } },
            { "Diese Datei läuft gerade. Lädst du eine neue herunter, ersetze genau sie.",
              new[] { "This is the file that is running. When you download a new one, replace exactly this.",
                      "正在运行的就是这个文件。下载新版本时，请替换它。",
                      "現在動いているのはこのファイルです。新しい版をダウンロードしたら、これを置き換えてください。" } },
            { "Ordner öffnen",
              new[] { "Open folder", "打开文件夹", "フォルダーを開く" } },
            { "Ordner ließ sich nicht öffnen: {0}",
              new[] { "Could not open the folder: {0}", "无法打开文件夹：{0}",
                      "フォルダーを開けませんでした：{0}" } },
            { "Fester Platz",
              new[] { "A fixed place", "固定位置", "固定の場所" } },
            { "Soll ich mich nach {0} kopieren und von dort laufen? Dann gibt es genau eine Datei, und dein Downloads-Ordner bleibt sauber.",
              new[] { "Shall I copy myself to {0} and run from there? Then there is exactly one file, and your downloads folder stays tidy.",
                      "要把我复制到 {0} 并从那里运行吗？这样就只有一个文件，你的下载文件夹也不会变乱。",
                      "{0} にコピーして、そこから実行しますか？そうすればファイルは一つだけになり、ダウンロードフォルダーも散らかりません。" } },
            { "Unter {0} liegt bereits eine Fassung. Soll sie durch diese ersetzt werden? Dann gibt es weiterhin genau ein Programm.",
              new[] { "There is already a version in {0}. Shall it be replaced by this one? Then there is still exactly one program.",
                      "{0} 中已经有一个版本。要用这个替换它吗？这样仍然只有一个程序。",
                      "{0} にはすでに別の版があります。これで置き換えますか？そうすればプログラムは一つのままです。" } },
            { "Der Umzug hat nicht geklappt: {0}",
              new[] { "The move did not work: {0}", "移动失败：{0}",
                      "移動できませんでした：{0}" } },
            { "Das Programm läuft weiter von seinem jetzigen Platz.",
              new[] { "The program keeps running from where it is now.",
                      "程序将继续从当前位置运行。",
                      "プログラムは今の場所から動き続けます。" } },
            { "Rückgängig ({0})",
              new[] { "Undo ({0})", "撤回（{0}）", "取り消し（{0}）" } },
            { "Zurückgeholt – du kannst es sofort nochmal versuchen.",
              new[] { "Taken back – you can try again right away.",
                      "已撤回 – 你可以立即重试。",
                      "取り消しました – すぐにもう一度お試しいただけます。" } },
            { "Zu spät – die Runde bleibt stehen.",
              new[] { "Too late – the round stays.",
                      "太晚了 – 这一局将保留。",
                      "遅すぎました – このラウンドはそのまま残ります。" } },
            { "Da ist gerade nichts zurückzuholen.",
              new[] { "There is nothing to take back right now.",
                      "目前没有可撤回的内容。",
                      "今は取り消せるものがありません。" } },
            { "Kopiert nach {0}",
              new[] { "Copied to {0}", "已复制到 {0}", "{0} にコピーしました" } },
            { "Starte künftig die Datei dort – der Ordner ist offen. Diese hier kannst du löschen.",
              new[] { "From now on start the file there – the folder is open. You can delete this one.",
                      "以后请从那里启动该文件 – 文件夹已打开。这个可以删除。",
                      "今後はそちらのファイルを起動してください – フォルダーを開きました。こちらは削除して構いません。" } },
            { "Bereit  –  {0} drücken",
            ...
            { "Erst am Ende der Runde drücken – die Punkte laufen bis zuletzt weiter. Dabei kurz stehen bleiben und auf einen ruhigen, kontrastreichen Hintergrund schauen: Himmel oder eine Wand statt buntem Boden.",
              new[] { "Press only at the end of the round – the score keeps changing until the last second. Stand still for a moment and look at a plain, high-contrast background: the sky or a wall rather than colourful ground.",
                      "请在回合结束时再按 – 分数会一直变动到最后一秒。请先站定不动，并面向单调、对比明显的背景：天空或墙壁，而不是花花绿绿的地面。",
                      "ラウンドが終わってから押してください – スコアは最後の瞬間まで変わります。その際、少し立ち止まり、空や壁など無地でコントラストのはっきりした背景を向いてください。" } },
